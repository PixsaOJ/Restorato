...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 2CHAjM4WKyXmd/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: lFJYiGeJtf1FF3/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___9CMoH)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__hoVGt)}
                role={"img"}
              />
            ),
